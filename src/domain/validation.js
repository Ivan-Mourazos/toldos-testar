...
import { normalizeAnticaMeasurementMode, normalizeAnticaVariant } from './anticaRules.js';
...
function normalizeAwning(awning, _index, legacyOrder = {}) {
  ...
  return {
    ...
    curtainFabricDeductionCm: numberOrDefault(awning?.curtainFabricDeductionCm, 0),    curtainFabricWidthDiscountCm: nullableNumber(awning?.curtainFabricWidthDiscountCm),
    ...
    anticaMeasurementMode: model === 'CAMBIO ANTICA'
