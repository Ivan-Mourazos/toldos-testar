...
export function createAwning(workType: Awning['workType'] = 'FULL_AWNING'): Awning {
  return {
    ...
    curtainSkipBottomDeduction: false,
    curtainTopFinish: '',
    ...
    electraFabricWidthDiscountCm: null,
    electraRollDiscountCm: null,
    electraLoadBarDiscountCm: null,
    electraBoxProfileDiscountCm: null,
