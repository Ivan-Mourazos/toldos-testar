...
Un modelo está terminado cuando cumple las diez condiciones. Son las de la [guía](./guia-revision-modelos.md#9-expediente-estados-y-criterio-de-cierre) convertidas en comprobaciones:
...
| 10 | Contrastado con el manual del fabricante (Iván, 22/09/2026) | Manual de Oficina Técnica o, si no está, catálogo o tarifa y búsqueda en la web; el expediente dice en qué se apoya cada decisión y las dudas van a [la lista única](./modelos/dudas-abiertas.md) |
...
| Xacobeo | 112 · 0 | Completa (25 OF) | 0 | **Terminado (23/09)** ([expediente](./modelos/xacobeo.md)): contrastado con el manual ART 250; pendiente Q-X01 |
