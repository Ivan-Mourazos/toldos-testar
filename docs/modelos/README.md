...
| CAMBIO TELA | Cambio de tela / CAMBIO DE TELA A TOLDO DE FACHADA | [Evidencia de trabajos de tela](../excel-fabric-jobs-evidence.md) · [Expediente](./cambio-tela.md) | Cerrado para su alcance (22/09): 917 trabajos de 2025-2026 sin diferencias sin explicar; reserva igual a la de los libros. Pendiente: muestra del PDF con taller y dudas Q-C06 (bamba en otra tela sin reservar) y Q-C07. Q-C02 resuelta: los +15 son decisión de cada pedido |
