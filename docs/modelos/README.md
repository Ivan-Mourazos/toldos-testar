...
| IRIS | Iris / aliases SCREENY 110, 130, 150 | [Evidencia](../rps-iris-evidence.md) · [Expediente](./iris.md) · [Informe de consumo](./informe-iris-hera-consumo.md) | Reserva parcial (23/09): casquillos, placa, tubo, pletina terminal, tapones, goma y kit de máquina o motor según el consumo real de 75 OF; 0 referencias rotas. Cofre, guías, cremallera y motor esperan Q-I01 a Q-I05 |
| HERA | HERA / ROLL-SYSTEM | [Evidencia](../rps-hera-evidence.md) · [Expediente](./hera.md) · [Informe de consumo](./informe-iris-hera-consumo.md) | Reserva la estructura según el consumo real (23/09): kit Swift, adaptadores, tubo, contrapeso y uniones, remate de abajo, macarrón y varilla; color pedido también a motor; 0 referencias rotas. Sin manual. Pendientes Q-H01, Q-H02, Q-H04 a Q-H10 |
