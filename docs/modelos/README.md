...
| --- | --- | --- | --- |
| BAMBALINA | Bambalina / BAMBALINA NUEVA | [Evidencia](../excel-fabric-jobs-evidence.md) · [Expediente](./bambalina.md) | En curso: cálculo validado contra los 947 Excel de 2026 (356/357), anidado de rollo corregido; solo queda abrir el 4111 (Q-B06) |
| ENROLLABLE | Enrollable / LONA PARA PUERTA ENROLLABLE | [Evidencia de trabajos de tela](../excel-fabric-jobs-evidence.md) | Pendiente: variantes de confección y dibujo. El anidado del rollo ya está corregido (Q-B09) |
...
| 14/09/2026 | Suplemento de bambalina | Iván aporta el plano del 4220 y resuelve Q-B04: dos altas separadas con OF propias, cada una calcula su tela, y broches y ollaos no se inventarían. Verificado en RPS que ninguna de las dos OF lleva más que LONA | Representar BN por canto, paso C/34 y coincidencia de broches en el plano |
