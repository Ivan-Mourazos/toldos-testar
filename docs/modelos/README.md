...
| CAMBIO TELA | Cambio de tela / CAMBIO DE TELA A TOLDO DE FACHADA | [Evidencia de trabajos de tela](../excel-fabric-jobs-evidence.md) · [Expediente](./cambio-tela.md) | Cerrado para su alcance (22/09): 917 trabajos de 2025-2026 sin diferencias sin explicar; reserva igual a la de los libros. Pendiente: muestra del PDF con taller. Dudas resueltas: +15 por pedido (Q-C02), bamba acrílica siempre se reserva y la de PVC no por ahora (Q-C06), rótulos del PDF sin cambios (Q-C07) |
