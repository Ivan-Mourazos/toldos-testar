...
- F-A01 · Dibujo de Cambio Antica: el rótulo "ENTRADA TUBO 50x30" se monta sobre la línea de la lona. Muestra en `output/modelos/cambio-cortina/` (prueba `tmp/ui-audit/otros-dibujos.mjs`).
  - Resuelto el 23/09/2026: rótulo 50×30 situado bajo ambas líneas, sin cambiar la geometría; regresión PDF para tubo normal y contrapeso. Capturas antes/después en `tmp/ui-audit/shots/antica-{antes,despues}.png`.
