...
| Q-B07 | Resuelta por Iván el 25/09/2026; pendiente de aplicar | En la línea del planteamiento va «bamba de tanto, hecha de tanto»; lo demás, en Observaciones. Revisar que la línea lleve solo eso y que el resto pase a Observaciones, en vez de remitir al pedido |
